...
export async function syncMoodEntry(
  ...
  try {
    ...
    console.error("[cloudSyncDirect] syncMoodEntry failed:", e);
  }
}
...
export async function loadCloudMoodEntries(
  ...
  try {
    ...
    console.error("[cloudSyncDirect] loadCloudMoodEntries failed:", e);
    return [];
  }
}
...
export async function syncPhq9Assessment(
  ...
  try {
    ...
    console.error("[cloudSyncDirect] syncPhq9Assessment failed:", e);
  }
}
...
export async function loadCloudPhq9Assessments(
  ...
  try {
    ...
    console.error("[cloudSyncDirect] loadCloudPhq9Assessments failed:", e);
    return [];
  }
}
...
export async function syncProfile(
  ...
  try {
    ...
    console.error("[cloudSyncDirect] syncProfile failed:", e);
  }
}
...
export async function loadCloudProfile(
  ...
  try {
    ...
    console.error("[cloudSyncDirect] loadCloudProfile failed:", e);
    return null;
  }
}
...
function buildBucketWritePayload(agg: SensorBucketAggregate) {
  const base: Record<string, unknown> = {
    ...
    count: firestore.FieldValue.increment(agg.count),
...
async function flushBucket(key: string): Promise<void> {
  ...
  try {
    ...
    console.error("[cloudSyncDirect] flushBucket failed:", e);
  }
}
